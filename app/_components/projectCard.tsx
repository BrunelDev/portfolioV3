...
export  function ProjectCard({image, title, description, link}: ProjectProps) {
    return (
      <Link href={link} className='border rounded-[8px] overflow-hidden border-[#2F3335] bg-[#47556900] w-full h-auto sm:h-[405px] flex flex-col gap-2 group transition-all hover:scale-[1.03] duration-200' target="blank">
