...
export const metadata: Metadata = {
  ...
  description: 'Software developer specializing in web development, mobile apps, and DevOps. Experienced with React, Next.js, Django, AWS and more.',
  keywords: ['Software Developer', 'Web Development', 'React', 'Next.js', 'Django', 'DevOps', 'AWS', 'Full Stack Developer'],
  ...
  openGraph: {
    ...
    title: 'Brunel Ahokpossi | Software Developer',
    description: 'Software developer specializing in web development, mobile apps, and DevOps',
